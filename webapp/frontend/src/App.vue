          ...
          <div v-if="accountInfo">
            <div class="text-center mb-6">
              ...
              <p class="text-xs text-gray-500 mt-2">
                Instance version: {{ accountInfo.instance_version || 'unknown' }}
              </p>
            </div>

            <!-- Version Warning -->
            <div v-if="!accountInfo.supports_quote_policies" class="bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg mb-6">
              <div class="flex items-start">
                <svg class="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                </svg>
                <div>
                  <strong>Incompatible Mastodon Version</strong>
                  <p class="text-sm mt-1">
                    This instance (version {{ accountInfo.instance_version }}) does not support quote policy management.
                    Quote policies require Mastodon 4.5 or later. Please ask your instance administrator to upgrade.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mb-6">
              ...
              <button
                ...
                :disabled="loading || hasEnabledQuotability || !accountInfo.supports_quote_policies"
                class="w-full bg-purple-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-purple-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <span v-if="!accountInfo.supports_quote_policies">
                  Not Supported (Requires Mastodon 4.5+)
                </span>
                <span v-else>
